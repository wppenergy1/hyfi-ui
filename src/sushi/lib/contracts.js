...
import WppOneAbi from './abi/wppone.json'
import {
  contractAddresses,
  SUBTRACT_GAS_LIMIT,
  supportedPools,
...
export class Contracts {
  constructor(provider, networkId, web3, options) {
    ...
    this.swap = new this.web3.eth.Contract(SwapAbi)
    this.wppone = new this.web3.eth.Contract(WppOneAbi)
  ...
  setProvider(provider, networkId) {
    ...
    setProvider(this.wppone, contractAddresses.wppone[networkId])
    setProvider(this.swap, contractAddresses.swap[networkId])
